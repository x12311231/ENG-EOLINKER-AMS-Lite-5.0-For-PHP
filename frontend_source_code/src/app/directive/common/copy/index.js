(function () {
    ...
    angular.module('eolinker')
        .directive('copyCommonDirective', ['$rootScope','$filter','Cache_CommonService',function ($rootScope,$filter,Cache_CommonService) {
            return {
                restrict: 'A',
                scope:{
                    copyModel:'<'
                ...
                link: function ($scope, elem, attrs, ctrl) {
                    ...
                    fun.init = (function () {
                        if(attrs.cacheVariable)service.cache.clear(attrs.cacheVariable);
