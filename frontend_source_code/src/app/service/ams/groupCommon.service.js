    ...
    function index(GroupService, CODE, $rootScope, $filter) {
                        ...
                        $rootScope.GroupModal(template.modal, function (callback) {
                            if (callback) {
                                ...
                                if (options.status == 'edit') {
                                    $filter('Field_CommonFilter')('object', callback, ['$index', 'isAdd', 'grandParentGroupID']);
                                    ...
                                    $filter('Field_CommonFilter')('object', callback, ['$index', 'groupID', 'isAdd', 'grandParentGroupID']);
        ...
        data.sort.init = function (input) {
            ...
            try {
                ...
                angular.forEach(input.groupList || input.apiGroupData, function (val, key) {
